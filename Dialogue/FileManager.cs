...
public class FileManager : MonoBehaviour
{
	...
	/// <param name="filePath">File path.</param>
	///this is for testing in editor, needs to be commented out for builds

	public static List<string> LoadFile(string filePath, bool removeBlankLines = true)
	{
        //IN EDITOR
        filePath = AttemptCorrectFilePath(savePath + filePath);
	...
	///this is for loading files in a build
	public static List<string> LoadFileInBuild(string filePath, bool removeBlankLines = true)
	{
		filePath = AttemptCorrectFilePath(filePath);
